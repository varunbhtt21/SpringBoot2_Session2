...
public class StudentController {
    ...
    @PostMapping("/student/{id}/passport")
    public Student allocatePassport(@PathVariable("id") String studentId,
                            @RequestBody Passport passport){

        Student student = studentsService.allocatePassport(studentId, passport);
        return student;
    }

    @PostMapping("/students/{id}/passport")
    public Student deallocatePassport(@PathVariable("id") String studentId,
                                    @RequestBody Passport passport){
